    ...
    <div id="dashboard">
        <ul class="collection with-header">
            ...
            <li v-for="employee in employees" v-bind:key="employee.id" class="collection-item">
                ...
                <router-link class="secondary-content" v-bind:to="{name: 'view-employee', params: {employee_id: employee.employee_id}}"><i class="material-icons">visibility</i></router-link>
